...
public class UiAutomationTrainingBasicTest extends TestBase {
	...
	public void testVerifyLogin() {
		...
		softAssert.assertTrue(LoginSecurePage.getLoginAlert().contains(Constants.LOGIN_SUCCESS_MSG), "You are not logged into login secure page");
		...
		softAssert.assertTrue(LoginPage.getLogoutAlert().contains(Constants.LOGOUT_SUCCESS_MSG), "You are not logged into login secure page");
		softAssert.assertAll();
	...
	public void testVerifyInvalidLogin(String username, String password) {
		...
		softAssert.assertTrue(HomePage.isHomePageDisplayed(), "Home Page is not Displayed");
		HomePage.clickLink(Constants.LOGIN_LINK);
		LoginPage.setUsernamePassword(username,username);
		LoginPage.clickLogin();
		softAssert.assertTrue(LoginPage.isInvalidAlertDisplayed(),"Invalid Login Alert is not Displayed");
		softAssert.assertTrue(LoginPage.getInvalidAlert().contains(Constants.LOGIN_INVALID_MSG),"Invalid Message is incorrect");
		softAssert.assertAll();
	}
